...
SRS_reviveTime      =    90;   // time to revive a downed player (randomizes +/- 25% of this val)
SRS_reviveTimer     =   600;   // time to death after being downed

SRS_medicAdvantage  =  0.50;   // Medic's revive this % faster (0->1)
